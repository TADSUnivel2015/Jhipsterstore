...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipsterstore@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipsterstore API";

        private String description = "jhipsterstore API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipsterstore";
